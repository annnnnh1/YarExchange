...
<template>
    <router-link :to="{name: 'starship', params:{name: starship.name}}" class=" bg-slate-400 rounded-md p-3 flex justify-between items-center">
        <div class="flex items-center gap-2">
            <p class="text-[20px] font-medium">{{starship.name}}</p>
            <span>(model: {{ starship.model }})</span>
        </div>
        <div class="flex items-center gap-3">
            <p>Перейти</p>
            <svg class="w-4" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="5px" y="5px" viewBox="0 0 492.004 492.004" style="enable-background:new 0 0 492.004 492.004;" xml:space="preserve">
